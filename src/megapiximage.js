...
/**
 * modified by qzone touch team
 *
 * advance the url getting method `getImageURL` for some browsers in China like uc, have a serious bug by calling the method of `createObjectURL`
 */
define([], function() {
	...
	function renderImageToCanvas(img, canvas, options, doSquash) {
		...
		var d = 2048; //1024; // size of tiling canvas
    ...
    var pixelRatio = (window.devicePixelRatio && window.devicePixelRatio > 1) ? window.devicePixelRatio : 1;
		var opt = { width : width * pixelRatio, height : height * pixelRatio };
